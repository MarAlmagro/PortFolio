  ...
  render(): React.ReactNode {
    return (
      ...
      <div className="bg-gradient row container-xxl-1">
        ...
        <footer>
          <div className="container-fluid row px-5 my-5 container-xxl-1">

            <div className=" my-5">
              <h5 className="col-12 d-flex justify-content-center display-6">Contacta conmigo</h5>
            </div>
            ...
            <div className='col-5 '>
              <div className="container row align-items-center mt-5">
                ...
                <div className="row align-items-center">
                  ...
                  <a className="col-11" href="www.linkedin.com/in/pedro-cuenca-panadero-391892225" >
                    <h5 className=" mx-5">www.linkedin.com/in/pedro-cuenca-panadero-391892225</h5>
                  </a>
